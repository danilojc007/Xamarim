...
namespace Puma.Droid
{
    ...
    [Activity(Label = "Puma", Icon = "@drawable/puma", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
